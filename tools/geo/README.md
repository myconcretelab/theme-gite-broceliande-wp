...
Le module SEO passe de 1.0.8 à 1.0.9. Les données métier restent dans Contrats/Booked. Aucun changement des formulaires, prix ou conditions de réservation.
