 ...
 * Slug: theme-gite-broceliande-wp/template-home-text-blog
...
<main class="wp-block-group" style="margin-top:var(--wp--preset--spacing--60)">
	...
	<h1 class="wp-block-heading alignwide has-x-large-font-size"><?php esc_html_e( 'Blog', 'theme-gite-broceliande-wp' ); ?></h1>
	<!-- /wp:heading -->
